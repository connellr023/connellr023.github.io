...
<ProjectPage
  ...
  repository={["UCSOAR", "https://github.com/UCSOAR"]}
>
  <h2 class="left-bar fade-in">overview</h2>
  <p class="left-bar fade-in">
    As an <i>Avionics Software Member</i> on the
  ...
  <p class="left-bar fade-in">
    I came onto the team with years of experience with web development in
  ...
  <p class="left-bar fade-in">
    However, with the introduction of binding CSS variables to specific parts of
    the various SVG elements in the background, it made it harder to make
    changes to the background. To solve this, I wrote an SVG pre-processor in <i
      >Rust</i
    > specific to our use case that would take in a base SVG file, a base CSS file,
    ...
    it easier to make changes to the background.
  </p>

  <h2 class="left-bar fade-in">integrating_qspi</h2>
  <p class="left-bar fade-in">
    Currently, my main task is to write an abstraction layer for <i>Quad-SPI</i>
    ...
    <i>STM32 HAL</i> documentation.
  </p>

  <h2 class="left-bar fade-in">nafe11388_driver</h2>
  <p class="left-bar fade-in">
    My secondary task is to write a driver for an <i>Analog Front-End (AFE)</i>
  ...
  <p class="left-bar fade-in">
    Below are some images of the Rocket Control Unit (RCU) GUI. The data being
    received from the server is simulated and does not reflect real data.
  </p>
  <div class="image-container">
    <img
      class="fade-in"
      src="/images/soar/dark-theme.png"
      alt="RCU GUI dark theme"
    />
    <img
      class="fade-in"
      src="/images/soar/light-theme.png"
      alt="RCU GUI light theme"
    />
    <img
      class="fade-in"
      src="/images/soar/loadcell-cal.png"
      alt="RCU GUI loadcell calibration pause"
    />
    <p class="left-bar fade-in">
      The above image is a screenshot of the loadcell calibration screen. The
      user can pause the calibration process at any time and resume it when they
      are ready. This is a user experience feature that I implemented.
    </p>
  </div>
</ProjectPage>
