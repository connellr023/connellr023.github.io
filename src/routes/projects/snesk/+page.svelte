...
<ProjectPage title="SNESK" category="school_projects" extraContributers={["Hillary Nguyen"]}>
    ...
    <div class="image-container">
        ...
        <img class="fade-in" src="/images/snesk/collect.jpg" alt="SNESK collect round gameplay" />
        <img class="fade-in" src="/images/snesk/hunt.jpg" alt="SNESK hunt round gameplay" />
