...
>
    ...
    <h2 class="left-bar">relevance</h2>
    <p class="left-bar">
    ...
    <h2 class="left-bar">highlights</h2>
    <p class="left-bar">
    ...
    <h2 class="left-bar">architecture</h2>
    <p class="left-bar">
    ...
    <div class="image-container">
        <img src="/images/self-checkout-station/1.png" alt="Self Checkout Station disabled" />
        <img src="/images/self-checkout-station/2.png" alt="Self Checkout Station ready" />
        <img src="/images/self-checkout-station/3.png" alt="Self Checkout Station session" />
        <img src="/images/self-checkout-station/4.png" alt="Self Checkout Station visual catalog" />
        <img src="/images/self-checkout-station/5.png" alt="Self Checkout Station with item added and text search" />
        <img src="/images/self-checkout-station/6.png" alt="Self Checkout Station payment" />
    </div>
</ProjectPage>
<Footer />
